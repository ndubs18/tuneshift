                ...
                <div className={styles.playlistCardDropdown}>
                    ...
                    {// Selecting the target apple music playlist 
                        ...
                        sourcePlatform === 'Spotify' ?
                            ...
                            :
                            <button onClick={async () => {
                                window.location.replace(`${process.env.REACT_APP_AUTH_SERVICE_BASE_URL}/login/spotify?source=${sourcePlatform}&sourcePlaylistId=${playlistId}&sourcePlaylistName=${name}`)
                            }}>Transfer</button>
                    }
                </div>
            </>
